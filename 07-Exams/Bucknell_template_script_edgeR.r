...
### Modified by Ken Field to work with repo at KField-Bucknell/SARTools
################################################################################
...
workDir <- "/path/to/your/working/directory/"        # working directory for the R session
...
# save image of the R session (Only advised for making permanent archive)
