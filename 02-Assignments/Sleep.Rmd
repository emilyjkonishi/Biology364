...
For most of the parameters, we will either have to transform the data so that it meets the assumption of a normal distribution or we will have to use non-parametric statistical tests.
