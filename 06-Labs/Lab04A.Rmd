...
```{r}
BatData <- read_csv("06-Labs/UgandaBatsFilteredMetrics.csv", 
...
Compare the numbers of male bats that are under 55 g to the number of female bats that are under 55 g using the filter() function.
