...
## Collaboration
1. Back on https://github.com/Bucknell-Biol364, you should see the whole list of class repos, including Prof. Field's main repo for the class: https://github.com/Bucknell-Biol364/Biology364. Enter that repo and explore.
...
1. For most homework assignments, you will find a template .Rmd file in your repository by Tuesday of the week it is due. (Homeworks are due Friday at noon, unless changed.)
